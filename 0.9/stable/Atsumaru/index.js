var source = (function (e) {
  ...
  var a = class {
    constructor() {
      i(this, `requiresExplicitSubmission`, !1);
    }
    reloadForm() {
      let e = this.__underlying_formId;
      e && Application.formDidChange(e);
    }
  };
  function o(e, t, n) {
    return (
      (e[`__closure_selector-` + t] = n),
      Application.Selector(e, `__closure_selector-` + t)
    );
  }
  function s(e, t) {
    let n;
    return (
      (n = typeof e == `string` ? { id: e } : e),
      {
        type: `listSection`,
        ...n,
        items: t.filter((e) => e),
  ...
  function c(e, t) {
    ...
    return (
      (n = typeof e == `string` ? { id: e } : e),
      { type: `flowSection`, ...n, items: t.filter((e) => e) }
    );
  }
  function l(e, t) {
    if (t.maxItemCount < 1)
      throw Error(`[${t.id}] maxItemCount must not be less than one`);
    if (t.minItemCount < 0)
      throw Error(`[${t.id}] minItemCount must not be less than zero`);
    if (t.minItemCount >= t.maxItemCount && t.maxItemCount > 1)
      throw Error(
        `[${t.id}] minItemCount must be less than maxItemCount, or both must be one`,
      );
    if (t.value.length < t.minItemCount)
      throw Error(`[${t.id}] value count must not be less than minItemCount`);
    if (!t.value.every((e) => t.items.some((t) => t.id === e)))
      throw Error(`[${t.id}] All provided values must be inside items`);
    let n = Object.keys(t.value).length;
    return (t.layout == `flow` ? c : s)(
      { id: t.id, header: t.header, footer: t.footer },
      t.items.map((r) => {
        let i = t.value.indexOf(r.id),
          a = i !== -1;
        return d(r.id, {
          title: r.title,
          value: a ? { symbol: `checkmark`, style: `success` } : void 0,
          onSelect: o(e, `__select_${t.id}#${r.id}`, async () => {
            if (a) n > t.minItemCount && t.value.splice(i, 1);
            else if (t.maxItemCount == 1)
              t.value.splice(0, t.value.length, r.id);
            else if (n < t.maxItemCount) t.value.push(r.id);
            else return;
            (t.onValueChange &&
              (await Application.SelectorRegistry.selector(t.onValueChange)()),
              e.reloadForm());
          }),
        });
      }),
      ...
      t.items.map((r) => {
        ...
        switch (i) {
          case `included`:
            t.layout == `flow`
              ? ((s = `success`), (a = void 0))
              : ((s = void 0), (a = { symbol: `checkmark`, style: `success` }));
            break;
          case `excluded`:
            t.layout == `flow`
              ? ((s = `error`), (a = void 0))
              : ((s = void 0), (a = { symbol: `xmark`, style: `error` }));
            break;
          default:
            ((a = void 0), (s = void 0));
        }
        return d(r.id, {
          ...
          title: r.title,
          value: a,
          onSelect: o(e, `__multiselect_${t.id}#${r.id}`, async () => {
            let a,
              o = !t.maximum || n < t.maximum,
              s = (t.allowEmptySelection && n == 1) || n > 1;
            switch (i) {
              case `included`:
                if (t.allowExclusion) {
                  a = `excluded`;
  ...
  function d(e, t) {
    return {
      ...
      isSelectable: t.onSelect != null,
    };
  }
  function f(e, t) {
    return { ...t, id: e, type: `inputRow`, isHidden: t.isHidden ?? !1 };
  }
  function p(e, t) {
  ...
  var ae = class extends _ {
      constructor(e, t) {
        (super(e),
          ...
          i(this, `currentRequestsMade`, 0),
          i(this, `lastReset`, Date.now()),
          i(
            this,
            `imageRegex`,
            new RegExp(/\.(avif|gif|jpeg|jpg|jxl|png|webp)(\?|$)/i),
          ),
          (this.options = t));
      }
      ...
      async incrementRequestCount() {
        if (
          (await this.promise,
          (Date.now() - this.lastReset) / 1e3 > this.options.bufferInterval &&
            ((this.currentRequestsMade = 0), (this.lastReset = Date.now())),
          (this.currentRequestsMade += 1),
          this.currentRequestsMade >= this.options.numberOfRequests)
        ) {
          let e = (Date.now() - this.lastReset) / 1e3;
          if (e <= this.options.bufferInterval) {
            let t = this.options.bufferInterval - e;
            (console.log(
              `[BasicRateLimiter] rate limit hit, sleeping for ${t}`,
            ),
              (this.promise = Application.sleep(t)));
          }
        }
      }
    },
  ...
  function b(e) {
    ...
    if (!n) throw Error(`Invalid URL string provided.`);
    if (
      (n[1] !== void 0 && n[1] !== `` && (t.protocol = n[1]),
      n[2] !== void 0 && n[2] !== ``)
    ) {
      let e = n[2],
        r = ``,
        ...
        a = e.indexOf(`@`);
      if (a !== -1) {
        if (((r = e.substring(0, a)), (i = e.substring(a + 1)), r !== ``)) {
          let e = r.indexOf(`:`);
          e === -1
            ? ((t.username = r), (t.password = ``))
            : ((t.username = r.substring(0, e)),
      ...
      if (i !== ``) {
        if (i.startsWith(`[`)) {
          ...
          t.hostname = i.substring(0, e + 1);
          let n = i.substring(e + 1);
          n.startsWith(`:`) && (t.port = n.substring(1));
        } else {
          let e = i.lastIndexOf(`:`);
          e !== -1 && i.indexOf(`:`) === e
    ...
    if (
      ...
      for (let t of r) {
        ...
        if (i in e) {
          let t = e[i];
          Array.isArray(t) ? t.push(a) : (e[i] = [t, a]);
        } else e[i] = a;
      }
      t.queryItems = e;
    }
  ...
  var x = class {
    ...
    toString() {
      ...
      if (
        (this.username !== void 0 &&
          ...
          (e += `@`)),
        (e += this.hostname),
        this.port !== void 0 && this.port !== `` && (e += `:${this.port}`),
        this.path !== `` &&
          (e += this.path.startsWith(`/`) ? this.path : `/${this.path}`),
        this.queryItems !== void 0)
      ) {
        let t = Object.keys(this.queryItems),
          n = [];
        if (t.length > 0)
          for (let e of t) {
            let t = this.queryItems[e];
            if (Array.isArray(t))
              for (let r of t)
      ...
      return (this.fragment !== void 0 && (e += `#${this.fragment}`), e);
    }
    setProtocol(e) {
      if (e === ``) throw Error(`Protocol is required`);
    ...
    addPathComponent(e) {
      return (
        (this.path = (this.path ?? ``) + (e.startsWith(`/`) ? e : `/${e}`)),
        this
      );
    }
    setQueryItems(e) {
      return ((this.queryItems = e), this);
    }
    setQueryItem(e, t) {
      return (
        this.queryItems === void 0 && (this.queryItems = {}),
        (this.queryItems[e] = t),
        this
      );
    }
    removeQueryItem(e) {
      return (delete this.queryItems?.[e], this);
    }
    setFragment(e) {
      return ((this.fragment = e), this);
    }
    update(e) {
      let t;
      return (
        ...
        t.hostname !== void 0 && this.setHostname(t.hostname),
        t.port !== void 0 && this.setPort(t.port),
        t.path !== void 0 && this.setPath(t.path),
        t.queryItems !== void 0 && this.setQueryItems(t.queryItems),
        t.fragment !== void 0 && this.setFragment(t.fragment),
        this
      );
    }
  };
  ...
  var se = class extends _ {
      ...
      set cookies(e) {
        let t = {};
        for (let n of e)
          this.isCookieExpired(n) || (t[this.cookieIdentifier(n)] = n);
        ((this._cookies = t), this.saveCookiesToStorage());
      }
      constructor(e) {
        (super(`cookie_store`),
          i(this, `options`, void 0),
      ...
      async interceptRequest(e) {
        return (
          (e.cookies = {
            ...(e.cookies ?? {}),
            ...this.cookiesForUrl(e.url).reduce(
      ...
      async interceptResponse(e, t, n) {
        let r = this._cookies;
        for (let e of t.cookies) {
          let t = this.cookieIdentifier(e);
          if (this.isCookieExpired(e)) {
            delete r[t];
            continue;
          }
          r[t] = e;
        }
        return ((this._cookies = r), this.saveCookiesToStorage(), n);
      }
      setCookie(e) {
        this.isCookieExpired(e) ||
          ((this._cookies[this.cookieIdentifier(e)] = e),
      ...
      cookiesForUrl(e) {
        ...
        if (!n) return [];
        let r = {},
          i = t.path.startsWith(`/`) ? t.path : `/${t.path}`,
          a = n.split(`.`),
          o = i.split(`/`);
        o.shift();
        let s = this.cookies;
        for (let e of s) {
          ...
          let t = this.cookieSanitizedDomain(e).split(`.`);
          if (a.length < t.length || t.length == 0) continue;
          let n = !0;
          ...
          if (!n) continue;
          let s = this.cookieSanitizedPath(e),
            c = s.split(`/`);
          c.shift();
          let l = 0;
          if (i === s) l = 2 ** 53 - 1;
          else if (c.length === 0 || s === `/`) l = 1;
          else if (i.startsWith(s) && o.length >= c.length)
            for (let e = 0; e < c.length && c[e] === o[e]; e++) l += 1;
          l <= 0 ||
            ((r[e.name]?.pathMatches ?? 0) < l &&
              (r[e.name] = { cookie: e, pathMatches: l }));
        }
        return Object.values(r).map((e) => e.cookie);
      }
      cookieIdentifier(e) {
        return `${e.name}-${this.cookieSanitizedDomain(e)}-${this.cookieSanitizedPath(e)}`;
      }
      cookieSanitizedPath(e) {
        return e.path?.startsWith(`/`) ? e.path : `/` + (e.path ?? ``);
      }
      cookieSanitizedDomain(e) {
        return e.domain.replace(/^(www)?\.?/gi, ``).toLowerCase();
      }
      isCookieExpired(e) {
        return !!(e.expires && e.expires.getTime() <= Date.now());
      }
  ...
  (function (e) {
    ((e[(e.NONE = 0)] = `NONE`),
      ...
      (e[(e.CHAPTER_PROVIDING = 1)] = `CHAPTER_PROVIDING`),
      (e[(e.MANGA_PROGRESS = 2)] = `MANGA_PROGRESS`),
      (e[(e.MANGA_PROGRESS_PROVIDING = 2)] = `MANGA_PROGRESS_PROVIDING`),
      (e[(e.PROGRESS_PROVIDING = 2)] = `PROGRESS_PROVIDING`),
      (e[(e.DISCOVER_SECIONS = 4)] = `DISCOVER_SECIONS`),
      (e[(e.DISCOVER_SECIONS_PROVIDING = 4)] = `DISCOVER_SECIONS_PROVIDING`),
      (e[(e.DISCOVER_SECTION_PROVIDING = 4)] = `DISCOVER_SECTION_PROVIDING`),
      (e[(e.COLLECTION_MANAGEMENT = 8)] = `COLLECTION_MANAGEMENT`),
      (e[(e.MANAGED_COLLECTION_PROVIDING = 8)] =
        `MANAGED_COLLECTION_PROVIDING`),
      (e[(e.CLOUDFLARE_BYPASS_REQUIRED = 16)] = `CLOUDFLARE_BYPASS_REQUIRED`),
      (e[(e.CLOUDFLARE_BYPASS_PROVIDING = 16)] = `CLOUDFLARE_BYPASS_PROVIDING`),
      (e[(e.SETTINGS_UI = 32)] = `SETTINGS_UI`),
      (e[(e.SETTINGS_FORM_PROVIDING = 32)] = `SETTINGS_FORM_PROVIDING`),
  ...
  (function (e) {
    ((e[(e.MANGA_CHAPTERS = 1)] = `MANGA_CHAPTERS`),
      ...
      (e[(e.HOMEPAGE_SECTIONS = 4)] = `HOMEPAGE_SECTIONS`),
      (e[(e.COLLECTION_MANAGEMENT = 8)] = `COLLECTION_MANAGEMENT`),
      (e[(e.CLOUDFLARE_BYPASS_REQUIRED = 16)] = `CLOUDFLARE_BYPASS_REQUIRED`),
      (e[(e.SETTINGS_UI = 32)] = `SETTINGS_UI`));
  })(H || (H = {}));
  ...
  G.createSourceStateManager = function () {
    return {
      keychain: {
        async store(e, t) {
          Application.setSecureState(t, e);
        },
        async retrieve(e) {
          return Application.getSecureState(e);
        },
      },
      async store(e, t) {
        Application.setState(t, e);
      },
      async retrieve(e) {
        return Application.getState(e);
      },
    };
  };
  function K(e) {
    ...
    e.param && (t += e.param);
    let n = {};
    for (let t of e.cookies ?? []) n[t.name] = t.value;
    return {
      url: t,
      method: e.method,
      body: e.data,
  ...
  function ye(e) {
    return {
      ...
      method: e.method,
      headers: e.headers ?? {},
      cookies: Object.keys(e.cookies ?? {}).map((t) => ({
        name: t,
        value: e.cookies[t],
        domain: ``,
      })),
  ...
  ((G.createRequestManager = function (e) {
    ...
    return (
      ...
      r.registerInterceptor(),
      {
        __backing_interceptor: t,
        __backing_rateLimit: n,
        __backing_cookieStore: r,
        ...
        async schedule(e) {
          ...
          return {
            ...
            headers: n.headers,
            status: n.status,
            data: Application.arrayBufferToUTF8String(r),
            get rawData() {
    ...
    (globalThis.App = new Proxy(G, {
      get(e, t) {
        ...
        if (typeof t == `string` && t.startsWith(`create`)) {
          if (t.startsWith(`createDUI`)) {
            let e = t.slice(6);
            return (t) =>
              Object.defineProperty(t, "type", { enumerable: !0, value: e });
          }
          return (e) => e;
        }
      },
  ...
  function Se(e) {
    let t = [],
      ...
      i = [],
      a = [],
      o = e.metadata?.find((e) => e.id === `tags`);
    if (o?.value && typeof o.value == `object`) {
      let e = o.value;
      Object.entries(e).forEach(([e, r]) => {
        (r === `included` && t.push(e), r === `excluded` && n.push(e));
      });
    }
    let s = e.metadata?.find((e) => e.id === `types`);
    if (s?.value && typeof s.value == `object`) {
      let e = s.value;
      Object.keys(e).forEach((t) => {
        e[t] === `included` && r.push(t);
      });
    }
    let c = e.metadata?.find((e) => e.id === `statuses`);
    if (c?.value && typeof c.value == `object`) {
      let e = c.value;
      Object.keys(e).forEach((t) => {
        e[t] === `included` && i.push(t);
      });
    }
    let l = e.metadata?.find((e) => e.id === `years`);
    if (l?.value && typeof l.value == `object`) {
      let e = l.value;
      Object.keys(e).forEach((t) => {
        let n = Number(t);
        e[t] === `included` && Number.isFinite(n) && a.push(n);
      });
    }
    ...
    return {
      ...
      selectedStatuses: i,
      selectedYears: a,
      minChapters: f !== null && Number.isFinite(f) && f > 0 ? f : null,
      officialTranslation:
        e.metadata?.find((e) => e.id === `officialTranslation`)?.value ===
        `true`,
    };
  }
  var Ce = class extends be {
    getSections() {
      return super.getSections().map((e) => ({
        ...e,
        items: e.items.map((e) =>
          e.id !== `minChapters` || e.type !== `inputRow`
            ? e
            : {
                ...e,
                value: X(e.value ?? ``),
      ...
      return (
        ...
        e.statuses &&
          ...
          n.push({
            ...
            id: `statuses`,
            title: `Status`,
            options: e.statuses.map((e) => ({ id: e.id, value: e.name })),
            value: {},
            allowExclusion: !1,
            allowEmptySelection: !0,
            maximum: void 0,
  ...
  function ke(e, t, n) {
    let r = e.chapters
      .map((e) => ({
        chapter: e,
        groupName: e.scanlationMangaId
          ? (n.get(e.scanlationMangaId) ?? `No Group`)
          : `No Group`,
      }))
      .sort((e, t) =>
        e.chapter.number === t.chapter.number
          ? e.groupName.localeCompare(t.groupName)
          : t.chapter.number - e.chapter.number,
      );
    return r.map(({ chapter: e, groupName: n }, i) => {
      let a = e.title
          .replace(
            /^((Chapter|Episode|Ch\.?)\s*[\d.]+|#\s*[\d.]+)\s*(\bS\d+\b)?\s*[-:]?\s*/i,
            ``,
          )
          .trim(),
        o = Number(e.title.match(/\bS(\d+)\b/i)?.[1] ?? 0);
      return {
        chapterId: e.id,
        sourceManga: t,
        title: a,
        ...
        langCode: `en`,
        version: n,
        sortingIndex: r.length - i,
        publishDate: new Date(e.createdAt),
      };
    });
  }
  async function Ae(e) {
            ...
            ? [
                {
                  id: `tags`,
                  title: `Tags`,
                  tags: n.genres.map((e) => ({ id: e.id, title: e.name })),
                },
              ]
            : [],
